...
<br>
<?php
$query = "SELECT * FROM tbl_product ORDER BY id_product ASC";
...
<form method="post" action="index.php?action=add&id=<?php echo $row["id_product"]; ?> ">
<div style="border:1px solid #333; background-color:#f1f1f1; border-radius:5px; padding:16px;" align="center">
<img src="<?php echo $row["item_img"]; ?>" class="img-responsive" /> </br>
